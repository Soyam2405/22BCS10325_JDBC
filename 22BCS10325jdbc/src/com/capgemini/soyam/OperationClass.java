...
public class OperationClass {
		...
		public void insert_record() throws ClassNotFoundException, SQLException {
			...
			String countStatus = "select max(ID) from jdbc815";
			...
			String insertQuery = "insert into jdbc815 values(?,?,?,?,?)";
...
public void delete() throws ClassNotFoundException, SQLException{
	System.out.println("Enter student UID:");
	String studentUID=sc.next();
	String searchQuery="select * from jdbc815 where studentUID=?";
	con=conObject.getConnection();
	...
	if(rs.next()) {
		...
		if (reply==1) {
			String deleteQuery="delete from jdbc815 where studentUID=?";
	...
	public void update() throws  SQLException, ClassNotFoundException {
		...
		String updatedQuery = "update jdbc815 set studentCourse=? where studentUID=?";
	...
	public void display_All() throws ClassNotFoundException, SQLException {
		...
		String searchQuery = "select * from jdbc815";
		con = conObject.getConnection();
		PreparedStatement psmt1 = con.prepareStatement(searchQuery);
